...
import{
  ...
  BsClock,
  BsBarChart,
  BsFileEarmarkText} from "react-icons/bs";
                ...
                [
                  {
                    ...
                    step:"STEP 1",
                    Role:"Role & Experience Selection",
                  ...
                  },
                  {
                    ...
                    desc:"Dynamic follow-up question based on youre answer"
                  },
                  {
                    icon:<BsClock size={24}/>,
                    step:"STEP 3",
                    Role:"Timer based Simulation",
                  ...
                  `}>
                      ...
                      {item.icon}
                        ...
                        <div className='pt-10 text-center'>
                          ...
                          <h3 className='font-semibold mb-3 text-lg '>{item.Role}</h3>
           ...
           <div className='grid md:grid-cols-2 gap-10'>
            {
              [
                ...
                },
                {
                  ...
                  desc:"detailed strenghts ,weakness and improvement insights"
                },
                {
                  image:pdfImg,
                  icon:<BsFileEarmarkText size={20}/>,
                ...
                },
                {
                  ...
                  desc:"track proggress with performace graph analysis"
                }
              ].map((item,index)=>(
                <motion.div 
                key={index}
