...
function Pricing() {
  ...
  const plans=[
    ...
    },
    {
      ...
      price:"₹199",
      credits:1500,
      description:"Best value for serioous job preperation",
      Features:[
            "1500 AI Interview Credits",
            "Advance  performace report",
    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50 py-16 px-6'>
      ...
      <div className='text-center w-full'>
        ...
        <p className='text-gray-500 mt-3 text-lg'>
          Flexible pricing to match. your interview peperation goals.
        </p>
      </div>
      </div>
          ...
          >
            ...
            {plan.default && (
              ...
              <div className='mt-6 space-y-3 text-left'>
                {plan.Features.map((feature,i)=>(
                  <div key={i} className='flex items-center gap-3'>
                      ...
                      <span className='text-emerald-500 text-sm'>{feature}</span>
                  </div>
      ))}
              </div>
              ...
              {!plan.default &&
                ...
                className={`w-full mt-8 py-3 rounded-xl transition font-semibold  ${isSelected?"bg-emerald-600 text-white hover:opacity-90":"bg-gray-100 text-gray-700 hover:bg-emerald-50"}`}>
